...
import com.example.broach.features.details.ui.ReporterDetailsFragment
            ...
            viewModel.uiState.collect { state ->
                when (state) {
                    ...
                    is SignupUiState.Success -> {
                        ...
                        val intent = Intent(requireActivity(), ReporterDetailsFragment::class.java).apply {
                            putExtra("USER_ROLE", "REPORTER")
                        }
